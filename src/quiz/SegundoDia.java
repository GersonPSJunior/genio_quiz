...
public class SegundoDia extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel6.setText("Quantos segundos tem");
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new SegundoDia().setVisible(true);
            }
        });
    }
